...
const AddTaskModal = ({ onSave, taskToUpdate, onCloseClick }) => {
  ...
  return (
    <>
      ...
      <form
        onSubmit={() => onSave(task, isAdd)}
        className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/36 bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11 absolute left-1/2 top-1/2 transform -translate-1/2 -translate-y-1/2 z-10"
      >
